...
DetailsIncomeModelClass detailsIncomeModelClassFromJson(String str) => DetailsIncomeModelClass.fromJson(json.decode(str));
String detailsIncomeModelClassToJson(DetailsIncomeModelClass data) => json.encode(data.toJson());
class DetailsIncomeModelClass {
  DetailsIncomeModelClass({
      int? statusCode, 
      Data? data,}){
  ...
  DetailsIncomeModelClass.fromJson(dynamic json) {
    _statusCode = json['StatusCode'];
    _data = json['data'] != null ? Data.fromJson(json['data']) : null;
  }
  int? _statusCode;
  Data? _data;
DetailsIncomeModelClass copyWith({  int? statusCode,
  Data? data,
}) => DetailsIncomeModelClass(  statusCode: statusCode ?? _statusCode,
  data: data ?? _data,
);
