...
TransactionExpenseModelClass transactionExpenseModelClassFromJson(String str) => TransactionExpenseModelClass.fromJson(json.decode(str));
String transactionExpenseModelClassToJson(TransactionExpenseModelClass data) => json.encode(data.toJson());
class TransactionExpenseModelClass {
  ...
  TransactionExpenseModelClass.fromJson(dynamic json) {
  ...
  int? _statusCode;
  List<Data>? _data;
TransactionExpenseModelClass copyWith({  int? statusCode,
  List<Data>? data,
}) => TransactionExpenseModelClass(  statusCode: statusCode ?? _statusCode,
  data: data ?? _data,
);
