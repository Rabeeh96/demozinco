import 'dart:convert';
/// StatusCode : 6000
/// data : [{"id":"f83aeaae-970e-44d5-98b6-3fdecf2ca904","from_account":{"id":"08ee1d13-03cb-4e5e-8f58-81c8909c17d3","account_name":"Test"},"to_account":{"id":"08ee1d13-03cb-4e5e-8f58-81c8909c17d3","account_name":"Test"},"created_user_id":1,"action":"A","is_delete":false,"finance_id":5,"finance_type":"1","date":"2023-05-27","time":"10:30:00","amount":"20.00000000","description":"income create","is_interest":false,"is_zakath":false,"organization":"35cf1533-4867-4d91-8ee2-05bdc5157129"},{"id":"e1a2624e-6791-4940-8937-33b222d7019e","from_account":{"id":"08ee1d13-03cb-4e5e-8f58-81c8909c17d3","account_name":"Test"},"to_account":{"id":"08ee1d13-03cb-4e5e-8f58-81c8909c17d3","account_name":"Test"},"created_user_id":1,"action":"A","is_delete":false,"finance_id":2,"finance_type":"0","date":"2023-05-27","time":"11:37:00","amount":"10.00000000","description":"create income","is_interest":false,"is_zakath":true,"organization":"35cf1533-4867-4d91-8ee2-05bdc5157129"},{"id":"b5246db2-efdf-480b-81a0-e882c00b9b86","from_account":{"id":"08ee1d13-03cb-4e5e-8f58-81c8909c17d3","account_name":"Test"},"to_account":{"id":"08ee1d13-03cb-4e5e-8f58-81c8909c17d3","account_name":"Test"},"created_user_id":1,"updated_user_id":1,"created_date":"2023-05-27T06:15:04.117387Z","updated_date":"2023-05-27T08:52:15.078530Z","action":"M","is_delete":false,"finance_id":4,"finance_type":"0","date":"2023-05-27","time":"14:22:00","amount":"100.00000000","description":"create expense","is_interest":false,"is_zakath":true,"organization":"35cf1533-4867-4d91-8ee2-05bdc5157129"}]

ListExpenseModelClass listExpenseModelClassFromJson(String str) => ListExpenseModelClass.fromJson(json.decode(str));
String listExpenseModelClassToJson(ListExpenseModelClass data) => json.encode(data.toJson());
class ListExpenseModelClass {
  ListExpenseModelClass({
      int? statusCode, 
      List<Data>? data,}){
  ...
  ListExpenseModelClass.fromJson(dynamic json) {
  ...
  int? _statusCode;
  List<Data>? _data;
ListExpenseModelClass copyWith({  int? statusCode,
  List<Data>? data,
}) => ListExpenseModelClass(  statusCode: statusCode ?? _statusCode,
  data: data ?? _data,
);
...
/// id : "f83aeaae-970e-44d5-98b6-3fdecf2ca904"
