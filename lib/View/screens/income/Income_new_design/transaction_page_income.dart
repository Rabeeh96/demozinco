...
class TransactionPageIncome extends StatefulWidget {
 ...
 final bool isReminder;
  ...
  @override
  State<TransactionPageIncome> createState() => _TransactionPageIncomeState();
}

class _TransactionPageIncomeState extends State<TransactionPageIncome> with SingleTickerProviderStateMixin {
  var userInput = '';
  ...
  ValueNotifier<bool> markAsZakath= ValueNotifier(false);
  ...
  void initState() {
    ...
    if (widget.type == "Edit") {
      ...
      markAsZakath = ValueNotifier(widget.isZakath!);
      ...
      markAsInterest = ValueNotifier(widget.isInterest!);
      markAsInterest = ValueNotifier(widget.isZakath!);
      finalAmount = "0.00";
    }
                  ...
                  Container(
                    child: Column(
                      children: [
                        ...
                        if (isIntrest == false && zakath == false) SizedBox(),
                                        ...
                                        onTap: (){
                                          ...
                                          if(widget.isFromNotification ==false){
                                            setReminderDatePicker(
                                                context, SetReminderDateNotifier);
                                          }
                        ...
                        onPressed: () {
                          ...
                          if(amount > 0.0){
                            ...
                            if(selectedFromAccountID ==""||selectedToAccountID ==""){
                              ...
                              createIncomeApi(isReminder: isReminderSet, date: apiDateFormat.format(SetReminderDateNotifier.value));
  ...
  createIncomeApi({required bool isReminder,required String date}) async {
