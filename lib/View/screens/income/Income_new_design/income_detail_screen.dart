...
import 'income_detail_filter.dart';
import 'transaction_page_income.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

class IncomeDetailScreen extends StatefulWidget {
  const IncomeDetailScreen({Key? key, required this.id, required this.AccountName, required this.total, required this.thisMonth}) : super(key: key);
  final String id;
...
class _IncomeDetailScreenState extends State<IncomeDetailScreen> {
  ...
  String getShortenedName(String fullName) {
    ...
    return fullName.length <= maxLength
        ? fullName
        : fullName.substring(0, maxLength - 1) + "...";
  }
  @override
            ...
            return Scaffold(
              ...
              appBar: AppBar(
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          "Income",
                          style: customisedStyle(context, Colors.green, FontWeight.normal, 11.0),
                        ),
                      ),
                ...
                actions: [
                  IconButton(
                      onPressed: () {
                        incomeBottomSheetClass.incomeAddBottomSheet(
                            context: context,
                            type: 'Edit',
                            addOrEdit: 'Edit',
                            id: widget.id,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                              onTap: () async {
                                final result = await Navigator.of(context).push(MaterialPageRoute(builder: (context) => IncomeDetailFilter()));
                                  ...
                                  return Container(
                                    child: Column(
                                      children: [
                                        ...
                                        modelClassDetailExpense.data![index].data!.isNotEmpty
                                            ? Container(
                                                                    ...
                                                                    children: [
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            countryCurrencyCode  + " "+
                                                                                "${roundStringWith(detailsItem.data![indexx].amount!)}",
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            ...
                                                                            style:
                                                                                customisedStyle(context, Color(0xff878787), FontWeight.normal, 12.0),
                                                                          ),
                                                                        ],
                                                                      ),
                                                                    ],
                        ...
                        if(modelClassDetailExpense.data!.isEmpty){
                          ...
                          for(var i =0 ;i<modelClassDetailExpense.data!.length;i++){
                            ...
                            for(var t =0 ;t<detailsItem!.length;t++){
                              ...
                              List<String?> a =[ modelClassDetailExpense.data![i].date, accountName, roundStringWith(detailsItem[t].amount!),notes];
                              data.add(a);
                            }
                          ...
                          var result = await Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => TransactionPageIncome(
                                ...
                                isFromNotification: false,
                                    ...
                                    to_accountName: "",
                                    description: "",
                                    from_account_id: widget.id,
                                    from_accountName: widget.AccountName,
                                    id: "",
                                    date: "",
                                    isInterest: false, isReminder: false,isReminderDate: "",
                                  )));
