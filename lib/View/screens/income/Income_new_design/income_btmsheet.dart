...
class IncomeBottomSheetClass {
  final formKey = GlobalKey<FormState>();

  incomeAddBottomSheet({required context, required String type, required String addOrEdit, String? typeName, String? id, String? organisation}) {
                ...
                if (state is CreateAccountLoaded) {
                  ...
                  if (createAccountModelClass.statusCode == 6000) {
                    ...
                    BlocProvider.of<AccountBloc>(context)
                        .add(ListAccountEvent(organisation: organizationId!, page_number: 1, page_size: 50, search: '', country: '', type: [3]));
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            type == "Create" ? 'Create Income' : "Edit Income",
