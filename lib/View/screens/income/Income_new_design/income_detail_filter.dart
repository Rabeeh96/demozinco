...
class IncomeDetailFilter extends StatefulWidget {
  const IncomeDetailFilter({Key? key}) : super(key: key);

  @override
  State<IncomeDetailFilter> createState() => _IncomeDetailFilterState();
}

class _IncomeDetailFilterState extends State<IncomeDetailFilter> {
