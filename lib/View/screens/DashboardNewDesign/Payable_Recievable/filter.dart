...
class FilterReceivablePayable extends StatefulWidget {
  const FilterReceivablePayable({Key? key, required this.type}) : super(key: key);
  final String type;

  @override
  State<FilterReceivablePayable> createState() => _FilterReceivablePayableState();
}

class _FilterReceivablePayableState extends State<FilterReceivablePayable> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("${widget.type} Filter",style: customisedStyle(
