...
class FilterForDashboardDetail extends StatefulWidget {
  const FilterForDashboardDetail({Key? key}) : super(key: key);

  @override
  State<FilterForDashboardDetail> createState() => _FilterForDashboardDetailState();
}

class _FilterForDashboardDetailState extends State<FilterForDashboardDetail> {
